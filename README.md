...
- **One thing at a time, always visible** — long work (a Duplicates FIND or DELETE MARKED, so far;
  the other tabs follow) runs in one central activity window that shows each phase, its progress and
