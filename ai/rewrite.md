...
Phases 0–7 (skeleton, store/registry, scan & update, dupes & diff, fingerprints &
similarity, GUI shell, duplicate review UI, file ops + similarity UI) all shipped between
2026-07-04 and 2026-07-05. This rewrite is complete; ongoing work is tracked in
`ai/improvements.md`.
