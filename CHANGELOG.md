...
- **Duplicates** tab: find exact or perceptually-similar duplicates across selected repos, review as file cards with a best-copy pick, and delete the rest; image/video/audio previews (text files preview their first lines on the card) and a zoom/pan lightbox with A/B compare.
